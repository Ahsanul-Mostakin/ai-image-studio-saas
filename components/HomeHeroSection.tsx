  ...
  return (
    <section className="home-hero">
      ...
      <div className="home-hero-stack">
        <nav className="hero-pill home-nav flex flex-wrap items-center justify-between gap-x-6 gap-y-3">
          <Link href="/" className="home-brand shrink-0">
          ...
          <div className="home-nav-center order-3 flex w-full flex-wrap items-center justify-center gap-x-7 gap-y-2 border-t border-border/40 pt-3 sm:order-none sm:w-auto sm:flex-nowrap sm:border-t-0 sm:pt-0">
            {CENTER_NAV_LINKS.map((link) => (
              <Link
                key={link.label}
                href={link.href}
                className="hero-nav-link inline-flex shrink-0 items-center gap-1"
              >
                {link.label}
          ...
          <div className="home-nav-auth shrink-0">
        ...
        <div className="home-hero-copy">
          <span className="home-hero-eyebrow">
            ...
            Upload &middot; Restyle &middot; Export
          </span>
          ...
          <div className="home-demo-shift">
            <div className="hero-demo-glass home-demo-glass-shell">
              <div className="hero-demo-glass-inner home-demo-inner">
                <Image
                  src="/demoo.png"
                  alt="AI Image Studio workspace showing upload, curated styles, and a before-and-after preview"
                  width={3290}
                  height={1872}
