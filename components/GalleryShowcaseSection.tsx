      ...
      <div className="relative z-10 mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="showcase-panel relative overflow-hidden rounded-[2rem] border border-border/70 p-6 sm:p-8 lg:p-10">
          ...
          <div className="relative z-10">
            <div className="grid gap-3 sm:grid-cols-4">
              {HIGHLIGHTS.map((item) => {
                ...
                return (
                  ...
                  >
                    <div className="mx-auto flex size-12 items-center justify-center rounded-2xl bg-accent/14 text-accent">
            ...
            <div className="mt-10">
              <p className="caps-lg font-mono text-xs font-medium uppercase tracking-[0.24em] text-accent sm:text-sm">
                Style showcase
              </p>
        ...
        >
          <div className="grid gap-4 sm:grid-cols-2">
            {GALLERY_IMAGES.map((image, index) => (
              <div
                key={image.src}
                className="showcase-image-card aspect-square overflow-hidden rounded-[1.8rem] border border-border/60"
              >
                <Image
                  src={image.src}
                  alt={image.alt}
