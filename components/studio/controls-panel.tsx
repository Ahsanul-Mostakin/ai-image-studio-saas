...
} from "@/lib/gemeni-image-models";
import { stylePresets } from "@/db/style-presets";
    ...
    <section className="studio-panel rounded-[2rem] border p-5 sm:p-7">
      ...
      <div className="studio-panel-inset mt-7 rounded-[1.8rem] border p-5">
        ...
        <p className="mt-3 text-sm leading-6 text-muted-foreground">
          Only image-edit-capable models are shown here, so generation stays
          compatible with your uploaded-image workflow.
        </p>
      </div>
      ...
      <p className="mt-5 text-center text-lg text-muted-foreground">
        Styling is powered by AI image edits.
      </p>
