...
export const GALLERY_IMAGES = [
  { src: "/gallery1.png", alt: "Stylized " },
  { src: "/gallery2.png", alt: "Stylized " },
  { src: "/gallery3.png", alt: "Stylized " },
  { src: "/gallery4.png", alt: "Stylized " },
] as const;

export const HERO_VIDEO_SRC =
  "https://ik.imagekit.io/y2qusbr99/218309_medium.mp4";

export const SHOWCASE_BG_VIDEO_SRC =
  "https://ik.imagekit.io/y2qusbr99/191684-891315375_medium.mp4";
...
export const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
  ...
  },
  {
    ...
    body: "AI Image Studio restyles the image while protecting composition, identity cues, and the small details that matter.",
    icon: SparklesIcon,
    featured: true,
  },
];
